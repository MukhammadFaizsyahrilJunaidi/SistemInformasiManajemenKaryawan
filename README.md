...
- `navbar-1.php` - Komponen Head & Session (Mengatur keamanan akses dan pemanggilan CSS).
- `navbar-2.php` - Komponen Topbar & Sidebar (Navigasi menu utama dan profil user).
...
- `uploads/` - Direktori penyimpanan berkas gambar.
